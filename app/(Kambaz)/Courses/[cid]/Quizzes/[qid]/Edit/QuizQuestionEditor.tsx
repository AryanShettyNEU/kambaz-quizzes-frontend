                      ...
                      <InputGroup.Text>
                        <Form.Check
                          ...
                          onChange={(e) => { 
                            ...
                            let newCorrectAnswers = [...tempQuestion.correctAnswers];
                            ...
                            if (isChecked) {
                              ...
                              newCorrectAnswers = newCorrectAnswers.filter((ans: string) => ans !== choice);
                            }

                            setTempQuestion({ ...tempQuestion, correctAnswers: newCorrectAnswers });
                          }}
                        />
                      </InputGroup.Text>
